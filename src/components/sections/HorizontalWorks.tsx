          ...
          {projects.map((project) => (
            <Magnetic key={project.id} intensity={0.2}>
              <a 
                ...
                className="project-card-wrap group relative w-[85vw] md:w-[550px] shrink-0 block"
              >
                <div className="aspect-[16/10] bg-foreground/5 rounded-2xl overflow-hidden mb-6 relative border border-border">
                  ...
                  />
                  {/* Top gradient shadow */}
                  <div className="absolute top-0 left-0 right-0 h-16 bg-gradient-to-b from-black/50 to-transparent pointer-events-none z-[1]" />
                  {/* Bottom gradient shadow */}
                  <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t from-black/50 to-transparent pointer-events-none z-[1]" />
                  <div className="absolute inset-0 bg-background/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center backdrop-blur-sm pointer-events-none z-[2]">
