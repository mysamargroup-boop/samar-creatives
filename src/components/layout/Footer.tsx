      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          <div className="space-y-6 flex flex-col items-start w-full md:w-auto">
            ...
            <p className="text-foreground/40 max-w-xs text-xs md:text-sm text-left">
        ...
        <div className="pt-12 border-t border-border flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 text-[10px] uppercase tracking-widest text-foreground/30 font-bold">
